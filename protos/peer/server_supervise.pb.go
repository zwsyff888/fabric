...
func (*PeerReply) Descriptor() ([]byte, []int) { return fileDescriptor8, []int{0} }
...
func (*ConnectPeer) Descriptor() ([]byte, []int) { return fileDescriptor8, []int{1} }
...
func (*PeerInfo) Descriptor() ([]byte, []int) { return fileDescriptor8, []int{2} }
...
func init() { proto.RegisterFile("peer/server_supervise.proto", fileDescriptor8) }
